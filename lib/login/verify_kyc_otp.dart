...
class VerifyKycOtp extends StatefulWidget {
  const VerifyKycOtp({Key? key}) : super(key: key);

  @override
  State<VerifyKycOtp> createState() => _VerifyKycOtpState();
}

class _VerifyKycOtpState extends State<VerifyKycOtp> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const VerifiyIdenty(),
                          ),
                        );
                      },
