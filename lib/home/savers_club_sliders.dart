...
class SaversClubSliders extends StatefulWidget {
  const SaversClubSliders({Key? key}) : super(key: key);

  @override
  _SaversClubSlidersState createState() => _SaversClubSlidersState();
}

class _SaversClubSlidersState extends State<SaversClubSliders> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: homeCtrl.database.ref().child("savers_club").onValue,
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () async {
                    ...
                    if (types[index]['type'] == "desc") {
                      Get.to(() => SaversClubDetail(types[index]));
                    } else if (types[index]['type'] == "url") {
                      await launchUrl(Uri.parse(types[index]['desc']));
                    } else {
                      log("dataa");
                    }
                  },
