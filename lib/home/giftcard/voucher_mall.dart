...
class voucher_mall extends StatefulWidget {
  const voucher_mall({Key? key}) : super(key: key);

  @override
  State<voucher_mall> createState() => _voucher_mallState();
}

class _voucher_mallState extends State<voucher_mall> {
   @override
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 240, 224, 165),
