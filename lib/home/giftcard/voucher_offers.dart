...
class voucher_offfers extends StatefulWidget {
  const voucher_offfers({Key? key}) : super(key: key);

  @override
  State<voucher_offfers> createState() => _voucher_offfersState();
}

class _voucher_offfersState extends State<voucher_offfers> {
  @override
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 181, 184, 227),
